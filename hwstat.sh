...
#rmem_default=$(sysctl net.ipv4.rmem_default | awk -F "= " '{print $2}')
#wmem_default=$(sysctl net.ipv4.wmem_default | awk -F "= " '{print $2}')
rmem_default=$(sysctl net.ipv4.tcp_rmem | awk '{print $4}') # rmem_default lower priority
wmem_default=$(sysctl net.ipv4.tcp_wmem | awk '{print $4}') # wmem_default lower priority
#rmem_max=$(sysctl net.core.tcp_rmem 2> /dev/null | awk '{print $5}')
#wmem_max=$(sysctl net.core.tcp_wmem 2> /dev/null | awk '{print $5}')
rmem_max=$(sysctl net.core.rmem_max 2> /dev/null | awk -F "= " '{print $2}') # tcp_rmem 3 param max lower priority
wmem_max=$(sysctl net.core.wmem_max 2> /dev/null | awk -F "= " '{print $2}') # tcp_wmem 3 param max lower priority
...
cron=$(crontab -l 2> /dev/null | sed "/^#\|^$/d" | wc -l)
...
echo "Cron jobs enabled count   : $cron"
