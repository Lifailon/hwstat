...
Hostname                   : devops-01
Uptime                     : 8 days 16:45 (2023-09-09 01:48:45)
Startup                    : 10.804s (kernel) + 40.423s (userspace) = 51.228s
Local Time                 : Sun 2023-09-17 18:34:05 MSK
...
Syslog service             : active (running) since Wed 2023-09-13 14:58:02 MSK; 4 days ago
...
Process Started count      : 267
Running/All Process        : 5/549
CPU avg 1/5/15 min         : 1.94 1.74 1.69
CPU avg usr/sys/wa/idle    : 16 14      0       70
CPU cur usr/sys/wa/idle    : 39 21      0       39
IOps avg in/out            : 21 1099
IOps current in/out        : 0  1088
MEM use/all/cache          : 1474/3876/2300 MB
MEM cache/buffer/dirty     : 1777048/278792/484 KB
SWAP use/all               : 428/3888 MB
...
Mount Filesystem free/all  : /dev/mapper/ubuntu--vg-ubuntu--lv (30G/57G), /dev/sda2 (1.6G/2.0G), //192.168.3.100/Backup (336G/1.9T)
Mount fstab count          : 4
...
Descriptor Files use/max   : 2880/9223372036854775807
Descriptor max for process : 1048576
List Open Files/All count  : 31916/39508
Limits count               : 0
...
Zabbix Agent status        : active (running) since Sat 2023-09-16 23:00:02 MSK; 19h ago
...
Hostname                   : pi-hole-01
Uptime                     : 2 days 5:42  (2023-09-15 12:57:28)
Startup                    : 10.681s (kernel) + 24.407s (userspace) = 35.088s
Local Time                 : Вс 2023-09-17 18:40:24 MSK
Time Zone                  : Europe/Moscow (MSK, +0300)
...
Syslog service             : active (running) since Fri 2023-09-15 12:57:46 MSK; 2 days ago
Syslog remote server       : 192.168.3.99:514 192.168.3.105:514
Syslog today/all error     : 0/0
Journal today/all error    : 14/1545
...
Running/All Process        : 1/607
CPU avg 1/5/15 min         : 0.04 0.07 0.06
CPU avg usr/sys/wa/idle    : 1  1       0       98
CPU cur usr/sys/wa/idle    : 1  3       0       96
IOps avg in/out            : 34 57
IOps current in/out        : 0  428
MEM use/all/cache          : 1077/1940/768 MB
MEM cache/buffer/dirty     : 669008/25588/260 KB
SWAP use/all               : 0/0 MB
SWAP Mount                 :
SWAP Running free mem      : 60 %
Cache background/ratio     : 10/20 %
...
Descriptor max for process : 1048576
List Open Files/All count  : 4147/6872
Limits count               : 0
...
Login pass min/max days    : 0/99999
ssh port/login pass/root   : 2121/yes/prohibit-password
Bash version               : 5.0.17
...
Zabbix Agent status        : active (running) since Fri 2023-09-15 12:57:47 MSK; 2 days ago
Zabbix Agent version       : 6.4.6
Zabbix config              : /etc/zabbix/zabbix_agentd.conf
